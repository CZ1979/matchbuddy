...
import TeamStrengthLegend from "./TeamStrengthLegend.jsx";
...
export default function TeamStrengthModal({ onClose }) {
  ...
  const portalTarget = useMemo(() => {
    ...
    return window.document?.body ?? null;
  }, []);
  ...
  return createPortal(
    <div
      ...
      aria-describedby="team-strength-modal-description"
    >
      ...
      <div className="relative z-10 w-full max-w-3xl">
        <div className="relative flex max-h-[80vh] flex-col overflow-hidden rounded-2xl bg-white p-6 shadow-xl">
          ...
          <div className="space-y-2 pr-4">
            ...
            <p id="team-strength-modal-description" className="text-sm text-slate-600">
